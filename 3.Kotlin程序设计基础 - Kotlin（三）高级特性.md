![image-20230821184810141](https://oss.itbaima.cn/internal/markdown/2023/08/21/g6flcuWhX7xK41z.png)
...
![image-20231224145801613](https://oss.itbaima.cn/internal/markdown/2023/12/24/HydGER9k7pleIbM.png)

因为泛型本身就是对某些待定类型的简单处理，如果都明确要使用什么类型了，那大可不必使用泛型。还有，不能通过这个不确定的类型变量就去直接创建对象：

![image-20231224145942619](https://oss.itbaima.cn/internal/markdown/2023/12/24/bvEcJO6hzWVILm7.png)

还有，由于泛型在创建时就已经确定，因此即使都是Score类，由于类型参数的不同也会导致不通用：

![image-20231224150118514](https://oss.itbaima.cn/internal/markdown/2023/12/24/XiAGHKbeaMDcTt6.png)
...
![image-20231224174024496](https://oss.itbaima.cn/internal/markdown/2023/12/24/Arojew9z7OnYigW.png)
...
![image-20231225000422558](https://oss.itbaima.cn/internal/markdown/2023/12/25/Zr6owjlEa8ekDAx.png)

但是现在存在这样一个问题，我们如果使用某个类型的父类呢，会不会出现类型不匹配的情况？

![image-20231225000541465](https://oss.itbaima.cn/internal/markdown/2023/12/25/w2H5ychAIOYX9S6.png)
...
![image-20231224155321582](https://oss.itbaima.cn/internal/markdown/2023/12/24/X7T8Uq5KEkgsASr.png)

![image-20231225004519670](https://oss.itbaima.cn/internal/markdown/2023/12/25/ok4fegPIxcFO9Tl.png)
...
![image-20231225020935723](https://oss.itbaima.cn/internal/markdown/2023/12/25/U7IjSuzdDLMGBHs.png)
...
![image-20231225010418319](https://oss.itbaima.cn/internal/markdown/2023/12/25/Hm81fOVTp5XcR24.png)
...
![image-20231225022706721](https://oss.itbaima.cn/internal/markdown/2023/12/25/yGZNjz59bq81LW2.png)
...
![image-20220922214604430](https://oss.itbaima.cn/internal/markdown/2023/12/25/VazkfM2FYGicIlq.png)
...
![image-20231225172109843](https://oss.itbaima.cn/internal/markdown/2023/12/25/v4w8mdaSDZM51t6.png)
...
![image-20231225172707649](https://oss.itbaima.cn/internal/markdown/2023/12/25/Ka586xf3vjkrNo4.png)
...
![image-20231225174845632](https://oss.itbaima.cn/internal/markdown/2023/12/25/c9mWKr7PgM1Uwkl.png)
...
![image-20220922221557130](https://oss.itbaima.cn/internal/markdown/2023/12/25/XO26TMJpKrf3YUH.png)
...
![image-20220723112639416](https://oss.itbaima.cn/internal/markdown/2023/12/25/f2BGNhqeV6nHdZp.png)
...
![image-20220723153933279](https://oss.itbaima.cn/internal/markdown/2023/12/25/bHFivT14Y7Wh8q6.png)
...
![image-20231226003204157](https://oss.itbaima.cn/internal/markdown/2023/12/26/o4kFTPj6MhmGbVl.png)
...
![image-20231226150034169](https://oss.itbaima.cn/internal/markdown/2023/12/26/xUAu26YMmlJgvsd.png)
...
![image-20231226150455150](https://oss.itbaima.cn/internal/markdown/2023/12/26/N5mXoR9UZLKkMD1.png)
...
![image-20231226151600596](https://oss.itbaima.cn/internal/markdown/2023/12/26/MsA7BdOH4IUWwxf.png)
...
![image-20231226005615234](https://oss.itbaima.cn/internal/markdown/2023/12/26/pjHCWwcmxL74uve.png)
...
![image-20221002150914323](https://oss.itbaima.cn/internal/markdown/2023/12/26/Lq7D1vTyabXlSR4.png)

一个新的迭代器就像上面这样，默认有一个指向集合中第一个元素的指针：

![image-20221002151110991](https://oss.itbaima.cn/internal/markdown/2023/12/26/VayvKxstH2enmqE.png)
...
![image-20231226173249641](https://oss.itbaima.cn/internal/markdown/2023/12/26/qjnkJfX41SlKoNQ.png)
...
![image-20231226232423784](https://oss.itbaima.cn/internal/markdown/2023/12/26/TjanZ3eEgsxzo2X.png)
...
![image-20231226232732629](https://oss.itbaima.cn/internal/markdown/2023/12/26/lMRLvSo1J5ydni6.png)
...
- 不允许为`.componentN()`和`.copy()`函数提供显式实现。
  ...
  ![image-20231227125926658](https://oss.itbaima.cn/internal/markdown/2023/12/27/fxIC8ZAdqzTKDs9.png)
...
![image-20231227180433658](https://oss.itbaima.cn/internal/markdown/2023/12/27/Za7QPWiNso8nFXE.png)
...
![image-20231227180748601](https://oss.itbaima.cn/internal/markdown/2023/12/27/XFmHoSbZiL289EY.png)
...
![image-20231227181629692](https://oss.itbaima.cn/internal/markdown/2023/12/27/GDpitSKX4EFIzoO.png)
...
![image-20231227182739956](https://oss.itbaima.cn/internal/markdown/2023/12/27/Qp8L7aRYuBovDfj.png)
...
![image-20231227182840106](https://oss.itbaima.cn/internal/markdown/2023/12/27/39GBhcEr54I8blv.png)
...
原文链接：https://www.itbaima.cn/zh-CN/document/v1zzvki0knb1xvml